...
func (_m *TeamService) Create(ctx context.Context, team *models.Team) error {
...
func (_m *TeamService) Delete(ctx context.Context, id string) error {
...
func (_m *TeamService) GetByID(ctx context.Context, id string) (*models.Team, error) {
	ret := _m.Called(ctx, id)
...
func (_m *TeamService) GetList(ctx context.Context, offset int, limit int) ([]*models.Team, error) {
...
func (_m *TeamService) Update(ctx context.Context, id string, team *models.Team) error {
