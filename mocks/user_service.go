...
func (_m *UserService) Create(ctx context.Context, user *models.User) error {
...
func (_m *UserService) GetByID(ctx context.Context, id string) (*models.User, error) {
	ret := _m.Called(ctx, id)
...
func (_m *UserService) GetList(ctx context.Context, offset int, limit int) ([]*models.User, error) {
...
func (_m *UserService) Update(ctx context.Context, id string, user *models.User) error {
