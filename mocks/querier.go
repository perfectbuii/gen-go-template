...
// SearchHub provides a mock function with given fields: ctx, dollar_1
func (_m *Querier) SearchHub(ctx context.Context, dollar_1 sql.NullString) ([]*models.Hub, error) {
	ret := _m.Called(ctx, dollar_1)

	var r0 []*models.Hub
	if rf, ok := ret.Get(0).(func(context.Context, sql.NullString) []*models.Hub); ok {
		r0 = rf(ctx, dollar_1)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]*models.Hub)
...
// SearchTeam provides a mock function with given fields: ctx, dollar_1
func (_m *Querier) SearchTeam(ctx context.Context, dollar_1 sql.NullString) ([]*models.Team, error) {
	ret := _m.Called(ctx, dollar_1)

	var r0 []*models.Team
	if rf, ok := ret.Get(0).(func(context.Context, sql.NullString) []*models.Team); ok {
		r0 = rf(ctx, dollar_1)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]*models.Team)
